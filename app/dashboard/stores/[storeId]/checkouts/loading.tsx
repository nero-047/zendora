  ...
  return (
    <div className="grid gap-5">
      ...
      <section className="glass-panel p-5 sm:p-6">
        <div className="h-4 w-36 animate-pulse rounded-[8px] bg-slate-200" />
        <div className="mt-4 h-8 w-80 max-w-full animate-pulse rounded-[8px] bg-slate-200" />
        <div className="mt-3 h-4 w-full max-w-xl animate-pulse rounded-[8px] bg-slate-200" />
      </section>
      <section className="dashboard-grid">
        {["recoverable", "open", "value", "recovered"].map((item) => (
